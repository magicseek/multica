		...
		r.Group(func(r chi.Router) {
			...
			r.Route("/api/projects", func(r chi.Router) {
				...
				r.Route("/{id}", func(r chi.Router) {
					...
					r.Put("/repositories", h.SetProjectRepositories)
			...
			r.Route("/api/repositories", func(r chi.Router) {
				...
				r.Route("/{id}", func(r chi.Router) {
					...
					r.Get("/bindings", h.ListRepositoryBindings)
			...
			r.Get("/api/tasks/{taskId}/outputs", h.ListTaskOutputMetadata)
			...
			r.Route("/api/chat/sessions", func(r chi.Router) {
				...
				r.Route("/{sessionId}", func(r chi.Router) {
					...
					r.Get("/plan-runs", h.ListChatPlanRuns)
			...
			r.Get("/api/chat/plan-engines", h.ListChatPlanEngines)
			r.Post("/api/chat/plan-runs/{planRunId}/cancel", h.CancelChatPlanRun)
