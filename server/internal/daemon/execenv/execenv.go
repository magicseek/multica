...
type TaskContextForEnv struct {
	...
	TriggerAuthorType              string // "agent" or "member" for comment-triggered tasks
	TriggerAuthorName              string // display name for the triggering comment author
	...
	TaskBundleID                   string
	TaskBundleChangesetMode        string
	TaskBundleRuntimeBudgetSeconds int32
	TaskBundleItems                []TaskBundleItemContextForEnv
...
type TaskBundleItemContextForEnv struct {
	ID              string
	IssueID         string
	Position        int32
	Status          string
